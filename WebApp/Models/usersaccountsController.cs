...
namespace WebApp.Models
{
    public class usersaccountsController : Controller
    {
        ...
        public usersaccountsController(WebAppContext context)
        {
            _context = context;
        }
        ...
        {
            SqlConnection conn1 = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\Administrator\\OneDrive\\Документы\\mynewdb2.mdf;Integrated Security=True;Connect Timeout=30");
            string sql;
