...
namespace WebApp.Controllers
{
    public class ordersController : Controller
    {
        ...
        public async Task<IActionResult> Create(int bookId, int quantity)
        {
            ...
            SqlConnection conn = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\Administrator\\OneDrive\\Документы\\mynewdb2.mdf;Integrated Security=True;Connect Timeout=30");
            string sql;
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebAppContext.orders'  is null.");
            }
            var orders = await _context.orders.FindAsync(id);
            if (orders != null)
            {
